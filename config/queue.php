    ...
    */
    ...
    'connections' => [
        ...
        'beanstalkd' => [
            ...
            'retry_after' => (int) env('BEANSTALKD_QUEUE_RETRY_AFTER', 300), // Igual que 'database' (ver arriba).
            'block_for' => 0,
            'after_commit' => false,
        ],
        ...
        'redis' => [
            ...
            'retry_after' => (int) env('REDIS_QUEUE_RETRY_AFTER', 300), // Igual que 'database' (ver arriba).
            'block_for' => null,
            'after_commit' => false,
        ],
