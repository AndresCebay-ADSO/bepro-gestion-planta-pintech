...
export default function ProductsEdit({ product, categories, units, can }: Props) {
            ...
            <div className="space-y-6 p-6">
                <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <span>/</span>
                        <Link href={productsShow({ product: product.id }).url} className="hover:text-foreground font-mono">
                            {product.code}
                        </Link>
                        <span>/</span>
                        <span>Editar</span>
                    ...
                    <h1 className="text-2xl font-semibold text-foreground">
                        Editar Producto: <span className="font-mono">{product.code}</span>
                    </h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
                    ...
                    {can.managePrices && (
                        <div className="rounded-lg border border-border bg-card p-6 space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="price_threshold">Umbral mínimo (%)</Label>
                                    <Input
                                        id="price_threshold"
                                        type="number"
                                        step="0.01"
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button type="button" variant="outline" asChild>
                            <Link href={productsShow({ product: product.id }).url}>Cancelar</Link>
                        </Button>
                    </div>
                </form>
            </div>
