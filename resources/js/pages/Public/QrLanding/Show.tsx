...
export default function PublicQrLandingShow({ product, lot, documents }: Props) {
    return (
        <>
            ...
            <main className="min-h-screen bg-muted/35 text-foreground antialiased">
                <header className="border-b border-border bg-card shadow-sm">
                    <div className="mx-auto flex max-w-5xl items-center gap-4 px-5 py-6">
                        ...
                        <div>
                            <p className="text-2xl font-bold tracking-tight text-foreground">PINTECH</p>
                    ...
                    <section className="rounded-xl border border-border bg-card p-6 shadow-sm md:p-8">
                        ...
                        <dl className="mt-8 grid gap-6 border-t border-border pt-8 md:grid-cols-3">
                            <div className="space-y-1">
                                <dt className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Lote / orden</dt>
                            ...
                            <div className="space-y-1">
                                <dt className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Fabricación</dt>
                                <dd className="text-xl font-semibold tracking-tight text-foreground">
                                    {lot.manufacturing_date ?? '—'}
                                </dd>
                            </div>
                            <div className="space-y-1">
                                <dt className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Verificación</dt>
                                <dd className="text-xl font-semibold tracking-tight text-foreground">
                    ...
                    <section className="rounded-xl border border-border bg-card p-6 shadow-sm md:p-8">
                        <div className="border-b border-border pb-4">
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">
                                Descargas ofrecidas para este lote. Los archivos pueden incluir certificados del lote y
                        ...
                        <div className="mt-6 space-y-3">
                            ...
                            {documents.length === 0 && (
                                <div className="rounded-lg border border-dashed border-border bg-muted/25 px-6 py-10 text-center">
                                    <FileText className="mx-auto mb-3 h-10 w-10 text-muted-foreground/70" aria-hidden />
                                    <p className="text-sm font-medium text-foreground">No hay documentos disponibles</p>
                                    <p className="mt-1 text-xs text-muted-foreground">
                                        Para este lote aún no hay PDFs publicados. Consulte con el fabricante si necesita
                                        la ficha técnica o la hoja de seguridad.
                                    </p>
                                </div>
                            )}
                        </div>
                ...
                <footer className="px-5 pb-10 pt-2 text-center text-sm text-muted-foreground">
