...
import type { FormNumberValue, ProductionOrder } from '@/types/production-orders';
            ...
            <CardContent className="space-y-2 p-4 text-xs">
                ...
                <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                        <FormattedNumber value={totalEquivalent} maxDecimals={2} />
                    </span>
                </div>
                <div className="flex justify-between">
                    <span className="text-muted-foreground">Costo granel acumulado:</span>
                    <span className="font-medium">
                        <FormattedNumber value={bulkCost} currency maxDecimals={2} />
                    </span>
                </div>
                <div className="flex justify-between">
                    <span className="text-muted-foreground">Costo terminado total:</span>
                    <span className="font-medium">
                        <FormattedNumber value={finishedCost} currency maxDecimals={2} />
                    </span>
                </div>
                <div className="flex justify-between">
                    <span className="text-muted-foreground">Margen producto (%):</span>
                    <span className="font-medium">
                        <FormattedNumber value={marginPercentage} maxDecimals={2} />%
                    </span>
                </div>
                <div className="flex justify-between">
                    <span className="text-muted-foreground">Margen estimado:</span>
                    <span className="font-medium">
                        <FormattedNumber value={estimatedMarginValue} currency maxDecimals={2} />
                    </span>
                </div>
                <div className="flex justify-between">
                    <span className="text-muted-foreground">Valor objetivo c/margen:</span>
                    <span className="font-medium">
                        <FormattedNumber value={estimatedTargetValue} currency maxDecimals={2} />
                    </span>
                </div>
            </CardContent>
        </Card>
