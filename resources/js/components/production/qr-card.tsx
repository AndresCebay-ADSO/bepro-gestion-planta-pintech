...
export function QrCard({ order, landingFullUrl, landingLinkCopied, onCopyLandingLink }: QrCardProps) {
    return (
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    {order.qr_image_url && (
                        <Button variant="outline" size="sm" asChild>
                            <a href={order.qr_image_url} download={`qr-lote-${order.order_number}.png`}>
                                <Download className="mr-1.5 h-4 w-4" />
                                Descargar QR
                            </a>
                        </Button>
                    )}
                    <Button type="button" variant="outline" size="sm" onClick={onCopyLandingLink}>
