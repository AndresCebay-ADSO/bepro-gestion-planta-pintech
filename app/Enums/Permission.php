...
enum Permission: string
{
    ...
    public function module(): PermissionModule
    {
        return match ($this) {
            ...
            self::UsersView, self::UsersCreate, self::UsersEdit, self::UsersDelete, self::UsersManageRoles => PermissionModule::Users,
            self::RolesView, self::RolesCreate, self::RolesEdit, self::RolesDelete => PermissionModule::Roles,
            self::AuditLogsView => PermissionModule::AuditLogs,
            self::CatalogsView, self::CatalogsCreate, self::CatalogsEdit, self::CatalogsDelete => PermissionModule::Catalogs,
            self::ProductsView, self::ProductsCreate, self::ProductsEdit, self::ProductsDeactivate, self::ProductsDelete, self::ProductsManageVariants, self::ProductsManageDocuments, self::ProductsDownloadDocuments => PermissionModule::Products,
            self::CostsView, self::CostsUpdate => PermissionModule::Costs,
            self::FormulasView, self::FormulasCreate, self::FormulasEdit, self::FormulasActivate, self::FormulasDelete => PermissionModule::Formulas,
            self::RawMaterialsView, self::RawMaterialsCreate, self::RawMaterialsEdit, self::RawMaterialsDeactivate, self::RawMaterialsReactivate, self::RawMaterialsDelete => PermissionModule::RawMaterials,
            self::ProductionOrdersView, self::ProductionOrdersCreate, self::ProductionOrdersOperate, self::ProductionOrdersSubmitForReview, self::ProductionOrdersRejectReview, self::ProductionOrdersComplete, self::ProductionOrdersCancel, self::ProductionOrdersExport => PermissionModule::ProductionOrders,
            self::ProductionRemnantsView => PermissionModule::ProductionRemnants,
            self::InventoryMovementsView, self::InventoryMovementsCreate => PermissionModule::InventoryMovements,
            self::FinishedInventoryView, self::FinishedInventoryMovementsView, self::FinishedInventoryMovementsCreate => PermissionModule::FinishedInventory,
            self::QuotationsViewOwn, self::QuotationsViewAll, self::QuotationsCreate, self::QuotationsEdit, self::QuotationsUpdateStatus, self::QuotationsConvertToOrder, self::QuotationsExportPdf => PermissionModule::Quotations,
            self::SalesOrdersViewOwn, self::SalesOrdersViewAll, self::SalesOrdersCreate, self::SalesOrdersEdit, self::SalesOrdersUpdateStatus => PermissionModule::SalesOrders,
            self::ClientsView, self::ClientsCreate, self::ClientsEdit, self::ClientsDelete => PermissionModule::Clients,
            self::PriceListsView => PermissionModule::PriceLists,
            self::PaintDevelopmentRequestsViewOwn, self::PaintDevelopmentRequestsViewAll, self::PaintDevelopmentRequestsCreate, self::PaintDevelopmentRequestsEdit, self::PaintDevelopmentRequestsSubmit, self::PaintDevelopmentRequestsUpdateStatus, self::PaintDevelopmentRequestsExportPdf => PermissionModule::PaintDevelopmentRequests,
            self::AlertsView, self::AlertsResolve => PermissionModule::Alerts,
            self::QrCodesView, self::QrCodesUpdate => PermissionModule::QrCodes,
            self::WarehousesView, self::WarehousesViewAll, self::WarehousesCreate, self::WarehousesEdit, self::WarehousesAssignUsers, self::WarehousesDelete => PermissionModule::Warehouses,
        };
    }
    ...
    {
        return match ($this) {
            self::DashboardView, self::FinishedInventoryView => [SystemRole::Admin, SystemRole::Production, SystemRole::Operator, SystemRole::Commercial],
            self::UsersView, self::UsersCreate, self::UsersEdit, self::UsersManageRoles, self::CatalogsView, self::ProductsCreate, self::ProductsEdit, self::ProductsDeactivate, self::ProductsManageDocuments, self::CostsView, self::CostsUpdate, self::FormulasView, self::FormulasCreate, self::FormulasEdit, self::FormulasActivate, self::RawMaterialsCreate, self::RawMaterialsEdit, self::RawMaterialsDeactivate, self::RawMaterialsReactivate, self::ProductionOrdersCancel, self::InventoryMovementsCreate, self::QuotationsViewAll, self::SalesOrdersEdit, self::ClientsEdit, self::ClientsDelete, self::PaintDevelopmentRequestsViewAll, self::PaintDevelopmentRequestsUpdateStatus, self::AlertsResolve, self::QrCodesUpdate, self::WarehousesViewAll, self::WarehousesCreate, self::WarehousesEdit, self::WarehousesAssignUsers => [SystemRole::Admin],
            self::UsersDelete, self::RolesView, self::RolesCreate, self::RolesEdit, self::RolesDelete, self::AuditLogsView, self::CatalogsCreate, self::CatalogsEdit, self::CatalogsDelete, self::ProductsDelete, self::FormulasDelete, self::RawMaterialsDelete, self::WarehousesDelete => [],
            self::ProductsView, self::ProductsDownloadDocuments, self::SalesOrdersViewOwn, self::QrCodesView, self::WarehousesView => [SystemRole::Admin, SystemRole::Production, SystemRole::Commercial],
            self::ProductsManageVariants, self::RawMaterialsView, self::ProductionOrdersCreate, self::ProductionOrdersRejectReview, self::ProductionOrdersComplete, self::FinishedInventoryMovementsView, self::FinishedInventoryMovementsCreate, self::SalesOrdersViewAll, self::SalesOrdersUpdateStatus, self::AlertsView => [SystemRole::Admin, SystemRole::Production],
            self::ProductionOrdersView, self::ProductionOrdersOperate, self::ProductionOrdersSubmitForReview, self::ProductionOrdersExport, self::ProductionRemnantsView, self::InventoryMovementsView => [SystemRole::Admin, SystemRole::Production, SystemRole::Operator],
            self::QuotationsViewOwn, self::QuotationsCreate, self::QuotationsEdit, self::QuotationsUpdateStatus, self::QuotationsConvertToOrder, self::QuotationsExportPdf, self::SalesOrdersCreate, self::ClientsView, self::ClientsCreate, self::PriceListsView, self::PaintDevelopmentRequestsViewOwn, self::PaintDevelopmentRequestsCreate, self::PaintDevelopmentRequestsEdit, self::PaintDevelopmentRequestsSubmit, self::PaintDevelopmentRequestsExportPdf => [SystemRole::Admin, SystemRole::Commercial],
        };
    }
}
