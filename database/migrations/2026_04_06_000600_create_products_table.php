...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->decimal('sales_margin', 5, 2)->nullable();
            ...
            $table->decimal('quality_viscosity_upper', 4, 1)->nullable();
            $table->decimal('quality_fineness_lower', 4, 1)->nullable();
            $table->decimal('quality_fineness_upper', 4, 1)->nullable();
            $table->decimal('quality_solids_lower', 4, 1)->nullable();
