...
class RawMaterialSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $quimicos = [
            ...
            ['code' => 'ABS-4 POL', 'unit' => 'kg'],
            ['code' => 'ABS-5', 'unit' => 'kg'],
            ['code' => 'ABS-5 P', 'unit' => 'kg'],
            ['code' => 'ABS-6', 'unit' => 'kg'],
            ['code' => 'ABS-7', 'unit' => 'kg'],
            ['code' => 'ABS-7 ALQ', 'unit' => 'kg'],
            ['code' => 'ABS-8', 'unit' => 'kg'],
            ['code' => 'ABS-8 C', 'unit' => 'kg'],
            ['code' => 'ABS-9', 'unit' => 'kg'],
            ['code' => 'ABS-9 A', 'unit' => 'kg'],
            ...
            ['code' => 'ABS-14', 'unit' => 'kg'],
            ['code' => 'ABS-14 C', 'unit' => 'kg'],
            ['code' => 'ABS-14 E', 'unit' => 'kg'],
            ['code' => 'ABS-15', 'unit' => 'kg'],
            ['code' => 'ABS-15 A', 'unit' => 'kg'],
            ['code' => 'ABS-16', 'unit' => 'kg'],
            ['code' => 'ABS-17', 'unit' => 'kg'],
            ['code' => 'ABS-18', 'unit' => 'kg'],
            ['code' => 'ABS-19', 'unit' => 'kg'],
            ...
            ['code' => 'R-4 P', 'unit' => 'kg'],
            ['code' => 'R-5', 'unit' => 'kg'],
            ['code' => 'R-5 S KER 3001', 'unit' => 'kg'],
            ['code' => 'R-5 S R-601', 'unit' => 'kg'],
            ['code' => 'R-5 S', 'unit' => 'kg'],
            ['code' => 'R-5 A', 'unit' => 'kg'],
            ['code' => 'R-5 C', 'unit' => 'kg'],
            ['code' => 'R-5 R', 'unit' => 'kg'],
            ...
            ['code' => 'AGUA DE SERVICIO', 'unit' => 'l', 'tracks_inventory' => false, 'current_price' => 0, 'minimum_stock' => 0, 'alert_days_before_expiry' => 0],
